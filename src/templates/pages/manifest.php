<div class="scene i:manifest manifest">
	...
	<p>
		...
		parentNode has fomulated the following development guidelines, challenging traditional
	...
	<ul class="manifest">
		...
		<li>Ignore cost of development in favour of making the right long term decisions</li>
		<li>Bring patience and expect hard work</li>
		<li>Explore, philosophize, rationalize</li>
		<li>Be uncompromizingly ambitious</li>
